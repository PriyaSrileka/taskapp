...
Visit your application in a browser at [http://localhost:3333] or  [http://192.168.99.100:3333/task]. If localhost is not working then try with your docker machine ip.
